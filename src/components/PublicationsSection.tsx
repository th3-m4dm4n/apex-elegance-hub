      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 animate-fade-up">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Dive deep into the technical world of Formula 1 with our comprehensive research articles, 
            data analyses, and insights from the cutting edge of motorsport technology.
          </p>
        </div>
